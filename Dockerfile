...
# Sends traces, metrics, and logs to OTLP collector via environment variable OTEL_EXPORTER_OTLP_ENDPOINT
# All telemetry flows through OTLP protocol on port 4317
